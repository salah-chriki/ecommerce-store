...
const PrivacyPage = () => {
  return (
    <ArticlePage title="Privacy Policy">
      <Article
        title="Privacy Policy"
        paragraph=" Lol RP SHOP website is owned by Starlight Services EV, which is a data
        controller of your personal data. We have adopted this Privacy Policy,
        which determines how we are processing the information collected by
        Lol RP SHOP, which also provides the reasons why we must collect
        certain personal data about you. Therefore, you must read this Privacy
        Policy before using Lol RP SHOP website. We take care of your personal
        data and undertake to guarantee its confidentiality and security."
      />
      <Article
        title="Personal information we collect:"
        paragraph="When you visit the Lol RP SHOP, we automatically collect certain
      ...
      <Article
        ...
        paragraph="Our top priority is customer data security, and, as such, we may
            ...
            identify any particular user of the system. You can visit the website
      ...
      />
      <Article
        title="The Links to other websites:"
        paragraph="Our website may contain links to other websites that are not owned or
      ...
      <Article
        ...
        paragraph="We secure information you provide on computer servers in a controlled,
      ...
      <Article
        ...
        paragraph="We will disclose any information we collect, use or receive if
      ...
      <Article
        ...
        paragraph="If you would like to contact us to understand more about this Policy
    ...
    //       <li>
    //         Rights in relation to automated decision-making and profiling. If
    ...
    //         note that your information might be transferred outside of Europe,
